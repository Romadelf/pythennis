...
def rechercheOmega(y0,cibleRebond) :
    ...
    pos_cylin = ci.convert_Car_to_Cy(y0[6],y0[7],y0[8])
    ...
    return R.bissection(f_omega, ci.omega_min, ci.omega_max , ci.tol) #bissection car se comporte mieux 
...
def rechercheOmega2(y0,cibleHauteur):
    ...
    def f_omega2(norm_w):
        ...
        r = Tj.np.sqrt((norm_w**2)-(pos_cylin[2]**2))
    ...
    return R.bissection(f_omega2,ci.omega_min,ci.omega_max, ci.tol)
